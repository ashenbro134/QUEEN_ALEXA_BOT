const isToxic = /(gandu|maderchod|bhosdike|bhosda|laud?a|chut?iya|maa ki chut|behenchod|behen ki chut|tatto ke saudagar|machar ki jhant|jhant? ka baal|Rand?i ka aulad|chuchi|booob?ie?s|to?lo?l|idiot|nigga|හුත්තා|පකයා|fuck|dick|bitch|tits|bastard|asshole|a[su,w,yu])/i;
...
export async function before(m, { isAdmin, isBotAdmin }) {
    ...
    if (chat.antiToxic && isAntiToxic) {
        ...
        var toxicityVerdict = [
            "ඔබ ඉතා මිත්‍රශීලී ය. ඔබව දැන ගැනීමට ලැබීම ඉතා සාදරයෙන් පිළිගනිමු!",
